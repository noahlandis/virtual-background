...
export function buildCanvas2dPipeline(sourcePlayback, backgroundConfig, segmentationConfig, canvas, bodyPix, tflite, addFrameEvent) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        addFrameEvent();
                        if (!(backgroundConfig.type !== 'none')) return [3, 3];
                        if (!(segmentationConfig.model === 'bodyPix')) return [3, 2];
                        return [4, runBodyPixInference()];
                    case 1:
                        _a.sent();
                        return [3, 3];
                    case 2:
    ...
    function runBodyPixInference() {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, bodyPix.segmentPerson(segmentationMaskCanvas)];
                    case 1:
