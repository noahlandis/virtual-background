...
function useTFLite(segmentationConfig) {
    var _a = useState(), tflite = _a[0], setTFLite = _a[1];
    var _b = useState(), tfliteSIMD = _b[0], setTFLiteSIMD = _b[1];
    var _c = useState(), selectedTFLite = _c[0], setSelectedTFLite = _c[1];
    var _d = useState(false), isSIMDSupported = _d[0], setSIMDSupported = _d[1];
    useEffect(function () {
        function loadTFLite() {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.trys.push([1, 3, , 4]);
                            return [4, createTFLiteSIMDModule()];
                        case 2:
                    ...
                    switch (_a.label) {
                        case 0:
                            ...
                            if (!newSelectedTFLite) {
                                throw new Error("TFLite backend unavailable: ".concat(segmentationConfig.backend));
                            }
                            modelFileName = getTFLiteModelFileName(segmentationConfig.model, segmentationConfig.inputResolution);
                            console.log('Loading tflite model:', modelFileName);
                            return [4, fetch("".concat(process.env.PUBLIC_URL, "/models/").concat(modelFileName, ".tflite"))];
                        case 1:
                            modelResponse = _a.sent();
                            return [4, modelResponse.arrayBuffer()];
                        case 2:
                            model = _a.sent();
